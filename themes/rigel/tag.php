    ...
    <div class="inner">
    	...
    	<div class="inner_wrapper">
    		<div class="sidebar_content">
		    	...
		    	<?php
		    		$pp_tag_layout = get_option('pp_tag_layout');
		    	
		    		//Get 1 column blog style layout
		    		if(file_exists(get_template_directory() . "/templates/template-blog-".$pp_tag_layout.".php"))
		    		{
			    		get_template_part ("templates/template", "blog-".$pp_tag_layout);
		    		}
		    		else
		    		{
