...
<?php
	...
	{
		$pp_menu_width = get_option('pp_menu_width');
...
<?php
	$pp_top_bar_bg = get_option('pp_top_bar_bg');
...
<?php
	$pp_top_bar_border = get_option('pp_top_bar_border');
...
<?php
	$pp_top_bar_social_color = get_option('pp_top_bar_social_color');
...
<?php
	$pp_top_bar_social_original = get_option('pp_top_bar_social_original');
...
<?php
	$pp_top_bar_breaking_header_font_color = get_option('pp_top_bar_breaking_header_font_color');
...
<?php
	$pp_top_bar_font_color = get_option('pp_top_bar_font_color');
...
<?php
	$pp_logo_bg = get_option('pp_logo_bg');
...
<?php
	$pp_logo_margintop = get_option('pp_logo_margintop');
...
<?php
	$pp_sub_menu_bg = get_option('pp_sub_menu_bg');
...
<?php
	$pp_sub_menu_border = get_option('pp_sub_menu_border');
...
<?php
	$pp_sub_menu_font_color = get_option('pp_sub_menu_font_color');
...
<?php
	$pp_sub_menu_active_bg_color = get_option('pp_sub_menu_active_bg_color');
...
<?php
	$pp_menu_active_style = get_option('pp_menu_active_style');
	$pp_menu_active_bg_color = get_option('pp_menu_active_bg_color');
...
<?php
	$pp_menu_border = get_option('pp_menu_border');
...
<?php
	$pp_mega_menu_widget_font_color = get_option('pp_mega_menu_widget_font_color');
...
<?php
	$pp_footer_bg = get_option('pp_footer_bg');
...
<?php
	$pp_footer_element_border = get_option('pp_footer_element_border');
...
<?php
	$pp_copyright_bg = get_option('pp_copyright_bg');
...
<?php
	$pp_widget_header_font_color = get_option('pp_widget_header_font_color');
...
<?php
	$pp_widget_header_bg_color = get_option('pp_widget_header_bg_color');
...
<?php
$pp_breaking_news_font_value = get_option('pp_breaking_news_font_value');

if(!empty($pp_breaking_news_font_value))
{
?>
h2.breaking, #autocomplete li.view_all { font-family: '<?php echo $pp_breaking_news_font_value; ?>' !important; }		
<?php
}
?>

<?php
$pp_menu_font_value = get_option('pp_menu_font_value');

if(!empty($pp_menu_font_value))
{
?>
.second_nav > li > a, .second_nav ul li ul.sub-menu li a, .second_nav li ul.sub-menu li a, .second_nav li .mega_menu_wrapper ul li ul.menu li a, .mobile_main_nav li a, .mobile_main_nav li a { font-family: '<?php echo $pp_menu_font_value; ?>' !important; }		
<?php
}
?>
...
<?php
	$pp_menu_font_upper = get_option('pp_menu_font_upper');
...
<?php
	$pp_menu_font_bold = get_option('pp_menu_font_bold');
...
<?php
$pp_body_font_value = get_option('pp_body_font_value');

if(!empty($pp_body_font_value))
{
?>
body, input[type=text], input[type=password], input[type=email], input[type=url], #contact_form textarea, #commentform textarea, #searchform input[type=text] { font-family: '<?php echo $pp_body_font_value; ?>' !important; }		
<?php
}
?>

<?php
$pp_header_tags_font_value = get_option('pp_header_tags_font_value');

if(!empty($pp_header_tags_font_value))
{
?>
h1, h2, h3, h4, h5, h6, h7, span[rel=author], a[rel=author], strong.title, a.post_title, .cat_link, blockquote:before, blockquote, ul.posts li h3, .second_nav li .mega_menu_wrapper ul li.widget_tag_cloud div.tagcloud a, .widget_tag_cloud div a, .meta-tags a, a.meta-tags, .more_story_title, .slider_wrapper .main_post_full .read_full, .slider_wrapper .main_post .read_full, .ppb_parallax_bg .post_title .read_full a, .ppb_video_bg .post_title .read_full a, .ppb_video_bg .post_title .read_full , .edit_review_wrapper .visual_value,.post_tag a, .post_category a, #copyright, .woocommerce ul.products li.product h3, .woocommerce-page ul.products li.product h3, .woocommerce-page ul.product_list_widget li a, .woocommerce ul.product_list_widget li a { font-family: '<?php echo $pp_header_tags_font_value; ?>' !important; }		
<?php
}
?>

<?php
	$pp_header_tags_font_bold = get_option('pp_header_tags_font_bold');
...
<?php
$pp_ppb_header_font_value = get_option('pp_ppb_header_font_value');

if(!empty($pp_ppb_header_font_value))
{
?>
h5.header_line { font-family: '<?php echo $pp_ppb_header_font_value; ?>' !important; }		
<?php
}
?>

<?php
$pp_ppb_desc_font_value = get_option('pp_ppb_desc_font_value');

if(!empty($pp_ppb_desc_font_value))
{
?>
.ppb_header .ppb_desc { font-family: '<?php echo $pp_ppb_desc_font_value; ?>' !important; }		
<?php
}
?>
...
<?php
	$pp_ppb_desc_font_size = get_option('pp_ppb_desc_font_size');
...
<?php
$pp_button_font_value = get_option('pp_button_font_value');

if(!empty($pp_button_font_value))
{
?>
input[type=submit], input[type=button], a.button, a.button:hover, a.button:active, .btn2 a, .btn2 a:hover, button, button:hover, #autocomplete li.view_all { font-family: '<?php echo $pp_button_font_value; ?>' !important; }		
<?php
}
?>
...
<?php
	$pp_content_font_color = get_option('pp_content_font_color');
...
<?php
	$pp_content_link_color = get_option('pp_content_link_color');
...
$pp_logo_alignment = get_option('pp_logo_alignment');
