...
<div id="post-<?php the_ID(); ?>" class="element animated<?php echo $count; ?> <?php if($count%3==0) { ?> last<?php } ?>" rel="three_columns">
    <div class="post_wrapper full">
    	...
    	<p>
    		<?php
            	echo pp_substr(strip_tags(strip_shortcodes(get_the_content())), 70);
            ?>
    	</p>
...
<?php if($count%3==0) { ?><br class="clear"/><?php } ?>
<!-- End each blog post -->
